          ...
          <section className="min-h-screen overflow-x-hidden flex flex-col-reverse lg:flex-row flex-nowrap pt-20">
            ...
            <div className="w-full lg:w-1/2 pt-10 p-6 lg:p-20 lg:pl-10">
              ...
              <p className="mb-6 text-center lg:text-left">
                Joseph je výsledkem vrcholové řemeslné zručnosti a navržen je
                pro ty, kteří od svého grilu očekávají nekompromisní kvalitu a
                výkon. Jeho geometrický design nejen osloví oko, ale také
                slibuje jedinečný zážitek z grilování. Díky certifikované
                potravinářské nerezové grilovací desce a možnosti přidání
                dalšího roštu nabízí Joseph nevídanou flexibilitu a odolnost.
              </p>
              <p className="mb-6 text-center lg:text-left">
                ...
                Připraven na všechny druhy počasí, přináší tento gril
                industriální eleganci do vašeho venkovního prostoru a slibuje
                roky spolehlivého užívání. K dispozici je také nerezový dekl,
                navržený k ochraně grilu před nepříznivými povětrnostními
                podmínkami, když se na něm právě negriluje, čímž prodlužuje jeho
                životnost.
              </p>
              <div className="mt-10 lg:mt-0 flex flex-col items-center justify-center lg:justify-start md:flex-row flex-nowrap gap-4 md:gap-10 mb-20 lg:mb-0">
                <div className="w-40">
                  <Button
                    link={globalLinks.eshopJoseph.cs}
                    inverse={false}
                    blank
                  >
                    Do e-shopu &raquo;
            ...
            <div className="w-full flex flex-col lg:flex-row flex-nowrap mb-16">
              ...
              <div className="w-full lg:w-1/3 flex flex-col items-center py-10 lg:p-8">
                ...
                <p className="text-mutedtext-dark text-center">
                  Navržen s ohledem na nejvyšší požadavky, kvalitu a výkon,
                  Joseph je ideální pro milovníky a nadšence do grilování, kteří
              ...
              <div className="w-full lg:w-1/3 flex flex-col items-center border-t lg:border-l lg:border-t-0 border-mutedtext-light py-10 lg:p-8">
                ...
                <p className="text-mutedtext-dark text-center">
                  ...
                  užívání, což z něj činí výbornou investici pro každého, kdo
                  chce spolehlivého partnera v přípravě grilovaných pochoutek.
                </p>
              </div>
              {/* --------- USP 3  --------- */}
              <div className="w-full lg:w-1/3 flex flex-col items-center border-t lg:border-l lg:border-t-0 border-mutedtext-light py-10 lg:p-8">
