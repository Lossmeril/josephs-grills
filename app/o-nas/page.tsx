...
const AboutPage = () => {
  return (
    <main className="max-w-[1200px] overflow-x-hidden mx-auto">
      ...
      <section className="min-h-[800px] pt-5 bg-white overflow-x-hidden flex flex-row flex-nowrap justify-center items-center gap-40 text-center border-t border-[#ededed]">
